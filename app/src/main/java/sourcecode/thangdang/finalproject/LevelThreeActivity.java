...
public class LevelThreeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGameItem1 = new GameItem(this,mBtnItem1, this.getResources().getString(R.string.item_1_lv3), R.raw.books_sound);
        mGameItem2 = new GameItem(this,mBtnItem2, this.getResources().getString(R.string.item_2_lv3),R.raw.cushionseat_sound);
        mGameItem3 = new GameItem(this,mBtnItem3, this.getResources().getString(R.string.item_3_lv3),R.raw.shelves_sound);
        mGameItem4 = new GameItem(this,mBtnItem4, this.getResources().getString(R.string.item_4_lv3),R.raw.tv_sound);
    ...
    public void init(){
        mBtnItem1 = (Button)findViewById(R.id.livingroom_item_books);
        mBtnItem2 = (Button)findViewById(R.id.livingroom_item_cushionseat);
        mBtnItem3 = (Button)findViewById(R.id.livingroom_item_shelves);
        mBtnItem4 = (Button)findViewById(R.id.livingroom_item_tivi);
    ...
    public void gameStart(){
        ...
        percent = 0;
        isFinish = false;
        song= MediaPlayer.create(this,R.raw.lv_3);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.livingroom_item_books:
                checkItem1 = true;
                ...
                break;
            case R.id.livingroom_item_cushionseat:
                checkItem2 = true;
                ...
                if(percent <= 75) {
                    ...
                    mTvResult.setText("You won");
                break;
            case R.id.livingroom_item_shelves:
                checkItem3 = true;
                ...
                if(percent <= 75) {
                    ...
                    mTvResult.setText("You won");
                break;
            case R.id.livingroom_item_tivi:
                checkItem4 = true;
    ...
    private void nextLevel(){
        Toast toast = Toast.makeText(LevelThreeActivity.this,"Unavailable",Toast.LENGTH_LONG);
        toast.show();
        finish();
    }
    ...
    public void isTheGameFinish(){
        ...
        setResult(Configs.REQ_CODE_CHOOSE_LEVEL_THREE,intent);
